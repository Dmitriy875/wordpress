 ...
 */
 ...
 Redux::setArgs(
    ...
    array(
        ...
        'display_version' => '4.1.1',
        'menu_title' => 'Redux',
        'admin_bar' => 'true',
        'page_slug' => 'redux_experiment',
        'menu_type' => 'menu',
        'allow_sub_menu' => true,
    )
 );
 ...
 Redux::setSection(
   'beauty',
   array(
        'id'    => 'сolor_customisation',
        'title' => 'Color customisation',
        'desc' => 'Цвета на Ваш вкус',
        'heading' => 'Изменение цвета для фона и текста',
        'icon' => 'el el-heart',
    )
);
Redux::setField(
	...
	array(
			...
			'section_id' => 'сolor_customisation',
			'title'      => 'Цвет фона',
			'subtitle'   => 'Выберите понравившийся',
			'desc'       => 'Заменяет цвет фона внутри тега <body>',
	)
);
